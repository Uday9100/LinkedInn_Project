...
destination_file_key = 'Consumer_data/company_specialities_Consumer/'  # S3 key for the output file

# Kafka Consumer setup
consumer = KafkaConsumer(
    'company_specialities_Producer',  # Kafka topic to subscribe to
    ...
    group_id='company_specialities_Consumer'  # Your consumer group ID
)
