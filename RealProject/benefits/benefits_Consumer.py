...
destination_file_key = 'Consumer_data/benefits_Consumer/'  # S3 key for the output file

# Kafka Consumer setup
consumer = KafkaConsumer(
    'benefits_Producer',  # Kafka topic to subscribe to
    ...
    group_id='benefits_Consumer'  # Your consumer group ID
)
