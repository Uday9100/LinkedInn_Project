...
destination_file_key = 'Consumer_data/companies_Consumer/'  # S3 key for the output file

# Kafka Consumer setup
consumer = KafkaConsumer(
    'companies_Producer',  # Kafka topic to subscribe to
    ...
    group_id='companies_Consumer'  # Your consumer group ID
)
